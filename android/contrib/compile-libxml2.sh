...
echo_usage() {
    echo "Usage:"
    echo "  compile-libxml2.sh armv5|armv7a|arm64|x86|x86_64"
    echo "  compile-libxml2.sh all|all32"
    echo "  compile-libxml2.sh all64"
...
case "$FF_TARGET" in
    "")
        echo_archs armv7a
        sh tools/do-compile-libxml2.sh armv7a
    ;;
