...
if [ "$FF_ARCH" = "armv7a" ]; then
    ...
    export CC="$FF_CROSS_PREFIX-gcc -D__ANDROID_API__=22"
...
echo "make CROSS_COMPILE=$FF_CROSS_PREFIX -j${CPU_COUNTS}"
make CROSS_COMPILE=$FF_CROSS_PREFIX -j${CPU_COUNTS}
make install
