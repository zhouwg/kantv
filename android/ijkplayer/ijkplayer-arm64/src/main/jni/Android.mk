...
MY_APP_ICONV_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/libiconv-arm64/output)
MY_APP_ICONV_INCLUDE_PATH := $(realpath $(MY_APP_ICONV_OUTPUT_PATH)/include)

MY_APP_XML2_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/libxml2-arm64/output)
