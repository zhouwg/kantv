...
MY_APP_ICONV_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/libiconv-armv5/output)
MY_APP_ICONV_INCLUDE_PATH := $(realpath $(MY_APP_ICONV_OUTPUT_PATH)/include)

MY_APP_XML2_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/libxml2-armv5/output)
MY_APP_XML2_INCLUDE_PATH := $(realpath $(MY_APP_XML2_OUTPUT_PATH)/include)

MY_APP_OPENSSL_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/openssl-armv5/output)
MY_APP_OPENSSL_INCLUDE_PATH := $(realpath $(MY_APP_OPENSSL_OUTPUT_PATH)/include)

MY_APP_CURL_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/curl-armv5/output)
