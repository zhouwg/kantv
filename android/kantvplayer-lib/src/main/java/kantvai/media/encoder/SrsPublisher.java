...
public class SrsPublisher {
    ...
    private static final String TAG = SrsPublisher.class.getName();
    ...
    private boolean sendVideoOnly = true;
    ...
    public void setEncodeOrientation(int orientation) {
