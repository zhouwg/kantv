 ...
 * protected stream.
 *
 * @see kantvai.media.encoder.iso.boxes.odf.OmaDrmKeyManagenentSystemBox
 * @see kantvai.media.encoder.iso.boxes.sampleentry.AudioSampleEntry#TYPE_ENCRYPTED
 * @see kantvai.media.encoder.iso.boxes.sampleentry.VisualSampleEntry#TYPE_ENCRYPTED
 */
