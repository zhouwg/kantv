...
import kantvai.media.encoder.mp4parser.FullContainerBox;
 ...
 *
 * @see kantvai.media.encoder.iso.boxes.sampleentry.VisualSampleEntry
 * @see kantvai.media.encoder.iso.boxes.sampleentry.TextSampleEntry
 * @see kantvai.media.encoder.iso.boxes.sampleentry.AudioSampleEntry
 */
