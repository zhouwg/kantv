...
package kantvai.media.encoder.iso.boxes.mdat;

import kantvai.media.encoder.iso.BoxParser;
import kantvai.media.encoder.iso.ChannelHelper;
 ...
 * by the metadata (see {@link kantvai.media.encoder.iso.boxes.SampleTableBox}).<br>
 ...
 * metadata refers to media data by its absolute offset within the file (see {@link kantvai.media.encoder.iso.boxes.StaticChunkOffsetBox});
