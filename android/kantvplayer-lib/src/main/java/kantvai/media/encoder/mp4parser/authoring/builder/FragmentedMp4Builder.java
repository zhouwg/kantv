...
import kantvai.media.encoder.iso.boxes.*;
import kantvai.media.encoder.iso.boxes.fragment.*;
...
public class FragmentedMp4Builder implements Mp4Builder {
     ...
     * <ul>
     * <li>{@link #createMvhd(kantvai.media.encoder.mp4parser.authoring.Movie) mvhd}</li>
     * <li>{@link #createMvex(kantvai.media.encoder.mp4parser.authoring.Movie)  mvex}</li>
     * <li>a {@link #createTrak(kantvai.media.encoder.mp4parser.authoring.Track, kantvai.media.encoder.mp4parser.authoring.Movie)  trak} for every track</li>
     * </ul>
     *
     * @param movie the concerned movie
     ...
     * isofile. Uses {@link #createTfra(kantvai.media.encoder.mp4parser.authoring.Track, kantvai.media.encoder.iso.IsoFile)}
     ...
     * by calling {@link #createTrex(kantvai.media.encoder.mp4parser.authoring.Movie, kantvai.media.encoder.mp4parser.authoring.Track)}
