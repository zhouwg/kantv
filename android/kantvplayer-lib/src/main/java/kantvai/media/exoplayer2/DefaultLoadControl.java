...
public class DefaultLoadControl implements LoadControl {
  ...
  //to
  //requirement For users with a good network to avoid/reduce rebuffer
  public static final int DEFAULT_MIN_BUFFER_MS = 60_000;
  ...
  //to
  //requirement For users with a good network to avoid/reduce rebuffer
  public static final int DEFAULT_MAX_BUFFER_MS = 120_000;
  ...
  //to
  public static final int DEFAULT_VIDEO_BUFFER_SIZE = 4000 * C.DEFAULT_BUFFER_SEGMENT_SIZE;

  /** A default size in bytes for an audio buffer. */
  //modify from original
  //public static final int DEFAULT_AUDIO_BUFFER_SIZE = 200 * C.DEFAULT_BUFFER_SEGMENT_SIZE;
  //to
  public static final int DEFAULT_AUDIO_BUFFER_SIZE = 400 * C.DEFAULT_BUFFER_SEGMENT_SIZE;
  ...
  private static final String TAG = DefaultLoadControl.class.getName();
  ...
  protected int calculateTargetBufferBytes(
    ...
    KANTVLog.j(TAG, "DEFAULT_MIN_BUFFER_SIZE: " + DEFAULT_MIN_BUFFER_SIZE / 1024  + "kbytes," + DEFAULT_MIN_BUFFER_SIZE / 1024 / 1024 + "Mbytes"); //12mbytes
    KANTVLog.j(TAG, "target buffer bytes:" + (max(DEFAULT_MIN_BUFFER_SIZE, targetBufferSize)) / 1024 + "kbytes," + (max(DEFAULT_MIN_BUFFER_SIZE, targetBufferSize)) / 1024 / 1024 + "Mbytes");
    return max(DEFAULT_MIN_BUFFER_SIZE, targetBufferSize); //275mbytes
  }
