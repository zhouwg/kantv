...
import kantvai.media.exoplayer2.source.MediaPeriodId;
...
public final class ExoPlaybackException extends PlaybackException {
  ...
  public static ExoPlaybackException createForUnexpected(
   ...
   //weiguo, add it for using ExoPlayer2 in kantv
   public static ExoPlaybackException createFromString(String message) {
     return new ExoPlaybackException(
             TYPE_SOURCE,
             /* cause= */ null,
