...
import kantvai.media.exoplayer2.DefaultMediaClock.PlaybackParametersListener;
import kantvai.media.exoplayer2.PlaybackException.ErrorCode;
import kantvai.media.exoplayer2.Player.DiscontinuityReason;
import kantvai.media.exoplayer2.Player.PlayWhenReadyChangeReason;
import kantvai.media.exoplayer2.Player.PlaybackSuppressionReason;
...
import kantvai.media.exoplayer2.source.MediaSource.MediaPeriodId;
...
import kantvai.media.exoplayer2.trackselection.TrackSelectorResult;
import kantvai.media.exoplayer2.upstream.BandwidthMeter;
import kantvai.media.exoplayer2.upstream.DataSourceException;
import kantvai.media.exoplayer2.util.Assertions;
import kantvai.media.exoplayer2.util.Clock;
import kantvai.media.exoplayer2.util.HandlerWrapper;
...
/* package */ final class ExoPlayerImplInternal
  ...
  public boolean handleMessage(Message msg) {
    try {
      ...
      if (e.isRecoverable && pendingRecoverableRendererError == null) {
        ...
        KANTVLog.j(TAG, "Playback error " + e.toString());
      ...
      KANTVLog.j(TAG, "Playback error " + error.toString());
      stopInternal(/* forceResetRenderers= */ true, /* acknowledgeStop= */ false);
  ...
  private void doSomeWork() throws ExoPlaybackException, IOException {
    ...
    if (finishedRendering && playingPeriodHolder.info.isFinal) {
      ...
      KANTVLog.j(TAG, "set state to STATE_BUFFERING");
