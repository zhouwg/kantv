...
import kantvai.media.exoplayer2.drm.UnsupportedMediaCrypto;
  ...
  public static String toLogString(@Nullable Format format) {
    ...
    if (format.drmInitData != null) {
      ...
      for (int i = 0; i < format.drmInitData.schemeDataCount; i++) {
        ...
        } else if (schemeUuid.equals(C.CHINADRM_UUID)) {
          schemes.add("chinadrm");
        } else if (schemeUuid.equals(C.WISEPLAY_UUID)) {
          schemes.add("wiseplay");
