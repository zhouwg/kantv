 ...
 */
package kantvai.media.exoplayer2.extractor.flv;
...
/* package */ final class VideoTagPayloadReader extends TagPayloadReader {
  private static final String TAG = VideoTagPayloadReader.class.getName();
  // Video codec.
  private static final int VIDEO_CODEC_AVC  = 7;

  //weiguo, add support HEVC
  ...
  protected boolean parseHeader(ParsableByteArray data) throws UnsupportedFormatException {
    ...
    // Support just H.264 & H.265 encoded content.
