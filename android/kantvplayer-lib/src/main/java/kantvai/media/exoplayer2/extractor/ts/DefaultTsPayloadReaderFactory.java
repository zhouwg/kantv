...
public final class DefaultTsPayloadReaderFactory implements TsPayloadReader.Factory {
  ...
  private static final String TAG = DefaultTsPayloadReaderFactory.class.getName();
  ...
  public TsPayloadReader createPayloadReader(int streamType, EsInfo esInfo) {
    KANTVLog.j(TAG, "stream type:" + streamType + "(0x" + Integer.toHexString(streamType) + ")");
    switch (streamType) {
      ...
      case TsExtractor.TS_STREAM_TYPE_SAMPLE_AES_H264: //weiguo, this is sample aes, make native multidrm & wiseplay happy
        KANTVLog.j(TAG, "h264");
      ...
      case TsExtractor.TS_STREAM_TYPE_SAMPLE_AES_H265: //weiguo, this is sample aes, make native multidrm & wiseplay happy
        KANTVLog.j(TAG, "h265");
      case TsExtractor.TS_STREAM_TYPE_DOLBY_VISION:
      ...
      default:
        KANTVLog.j(TAG, "unknown stream type:" + streamType + "(0x" + Integer.toHexString(streamType) + ")");
        return null;
    }
  }
