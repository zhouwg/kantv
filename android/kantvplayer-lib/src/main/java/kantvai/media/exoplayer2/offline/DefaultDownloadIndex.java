...
import kantvai.media.exoplayer2.database.DatabaseIOException;
import kantvai.media.exoplayer2.database.DatabaseProvider;
import kantvai.media.exoplayer2.database.VersionTable;
import kantvai.media.exoplayer2.offline.Download.FailureReason;
import kantvai.media.exoplayer2.offline.Download.State;
