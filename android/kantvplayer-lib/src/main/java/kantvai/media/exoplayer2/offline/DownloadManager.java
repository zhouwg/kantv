...
import static kantvai.media.exoplayer2.offline.Download.FAILURE_REASON_NONE;
import static kantvai.media.exoplayer2.offline.Download.FAILURE_REASON_UNKNOWN;
import static kantvai.media.exoplayer2.offline.Download.STATE_COMPLETED;
import static kantvai.media.exoplayer2.offline.Download.STATE_DOWNLOADING;
import static kantvai.media.exoplayer2.offline.Download.STATE_FAILED;
import static kantvai.media.exoplayer2.offline.Download.STATE_QUEUED;
import static kantvai.media.exoplayer2.offline.Download.STATE_REMOVING;
import static kantvai.media.exoplayer2.offline.Download.STATE_RESTARTING;
import static kantvai.media.exoplayer2.offline.Download.STATE_STOPPED;
import static kantvai.media.exoplayer2.offline.Download.STOP_REASON_NONE;
...
import kantvai.media.exoplayer2.scheduler.Requirements;
import kantvai.media.exoplayer2.scheduler.RequirementsWatcher;
import kantvai.media.exoplayer2.upstream.DataSource;
import kantvai.media.exoplayer2.upstream.DataSource.Factory;
import kantvai.media.exoplayer2.upstream.cache.Cache;
import kantvai.media.exoplayer2.upstream.cache.CacheDataSource;
import kantvai.media.exoplayer2.upstream.cache.CacheEvictor;
