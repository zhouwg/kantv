...
import kantvai.media.exoplayer2.source.ads.AdsMediaSource;
import kantvai.media.exoplayer2.ui.AdViewProvider;
  ...
  private static SparseArray<MediaSourceFactory> loadDelegates(
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("kantvai.media.exoplayer2.source.dash.DashMediaSource$Factory")
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName(
                  "kantvai.media.exoplayer2.source.smoothstreaming.SsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_SS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("kantvai.media.exoplayer2.source.hls.HlsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_HLS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("kantvai.media.exoplayer2.source.rtsp.RtspMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
