...
/**
 * Defines and provides media to be played by an {@link kantvai.media.exoplayer2.ExoPlayer}. A
 ...
 * kantvai.media.exoplayer2.ExoPlayer} Javadoc. They should not be called directly from
 * application code. Instances can be re-used, but only for one {@link
 * kantvai.media.exoplayer2.ExoPlayer} instance simultaneously.
 */
public interface MediaSource {
   ...
   * kantvai.media.exoplayer2.source.MediaPeriodId}.
   */
  final class MediaPeriodId extends kantvai.media.exoplayer2.source.MediaPeriodId {

    /** See {@link kantvai.media.exoplayer2.source.MediaPeriodId#MediaPeriodId(Object)}. */
    public MediaPeriodId(Object periodUid) {
      super(periodUid);
    }

    /**
     * See {@link kantvai.media.exoplayer2.source.MediaPeriodId#MediaPeriodId(Object, long)}.
     */
    ...
    /**
     * See {@link kantvai.media.exoplayer2.source.MediaPeriodId#MediaPeriodId(Object, int, int,
     * long)}.
     */
    ...
    /** Wraps an {@link kantvai.media.exoplayer2.source.MediaPeriodId} into a MediaPeriodId. */
    public MediaPeriodId(kantvai.media.exoplayer2.source.MediaPeriodId mediaPeriodId) {
      super(mediaPeriodId);
    }

    /** See {@link kantvai.media.exoplayer2.source.MediaPeriodId#copyWithPeriodUid(Object)}. */
    @Override
    ...
    /**
     * See {@link
     * kantvai.media.exoplayer2.source.MediaPeriodId#copyWithWindowSequenceNumber(long)}.
     */
    @Override
