...
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_EAGERLY_EXPOSE_TRACK_TYPE;
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_EXPOSE_CAPTION_FORMATS;
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_EXPOSE_CHUNK_INDEX_AS_MEDIA_FORMAT;
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_EXPOSE_DUMMY_SEEK_MAP;
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_INCLUDE_SUPPLEMENTAL_DATA;
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_IN_BAND_CRYPTO_INFO;
import static kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil.PARAMETER_OVERRIDE_IN_BAND_CAPTION_DECLARATIONS;
...
import kantvai.media.exoplayer2.extractor.ChunkIndex;
...
import kantvai.media.exoplayer2.source.mediaparser.InputReaderAdapterV30;
import kantvai.media.exoplayer2.source.mediaparser.MediaParserUtil;
import kantvai.media.exoplayer2.source.mediaparser.OutputConsumerAdapterV30;
