...
import kantvai.media.exoplayer2.offline.FilteringManifestParser;
...
import kantvai.media.exoplayer2.source.MediaSourceEventListener.EventDispatcher;
import kantvai.media.exoplayer2.source.MediaSourceFactory;
import kantvai.media.exoplayer2.source.SequenceableLoader;
import kantvai.media.exoplayer2.source.dash.PlayerEmsgHandler.PlayerEmsgCallback;
...
import kantvai.media.exoplayer2.source.dash.manifest.DashManifestParser;
import kantvai.media.exoplayer2.source.dash.manifest.Period;
import kantvai.media.exoplayer2.source.dash.manifest.Representation;
import kantvai.media.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import kantvai.media.exoplayer2.util.SntpClient;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      kantvai.media.exoplayer2.source.dash.manifest.Period period =
