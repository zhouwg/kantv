...
public class AdaptationSet {
  ...
  /**
   * The type of the adaptation set. One of the {@link kantvai.media.exoplayer2.C} {@code
   ...
   * @param type The type of the adaptation set. One of the {@link kantvai.media.exoplayer2.C}
