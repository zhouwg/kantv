...
import kantvai.media.exoplayer2.source.chunk.DataChunk;
...
/* package */ class HlsChunkSource {
  ...
  private static final String TAG = HlsChunkSource.class.getName() ;
  ...
  public void maybeThrowError() throws IOException {
    if (fatalError != null) {
      KANTVLog.j(TAG, "fatal error: " + fatalError.toString());
      throw fatalError;
    }
    if (expectedPlaylistUrl != null && seenExpectedPlaylistError) {
      KANTVLog.j(TAG, "expectedPlaylistUrl: " + expectedPlaylistUrl + ",seenExpectedPlaylistError: " + seenExpectedPlaylistError);
  ...
  public void getNextChunk(
    ...
    if (chunkMediaSequence < playlist.mediaSequence && previous != null && switchingTrack) {
      KANTVLog.j(TAG, "chunkMediaSequence=" + chunkMediaSequence + "  playlist.mediaSequence=" + playlist.mediaSequence);
