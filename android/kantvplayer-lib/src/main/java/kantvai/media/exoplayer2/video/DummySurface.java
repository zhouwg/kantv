...
import static kantvai.media.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_NONE;
import static kantvai.media.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_PROTECTED_PBUFFER;
import static kantvai.media.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_SURFACELESS_CONTEXT;
...
import kantvai.media.exoplayer2.util.EGLSurfaceTexture;
import kantvai.media.exoplayer2.util.EGLSurfaceTexture.SecureMode;
import kantvai.media.exoplayer2.util.GlUtil;
