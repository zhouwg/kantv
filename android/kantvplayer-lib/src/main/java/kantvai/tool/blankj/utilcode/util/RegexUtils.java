package kantvai.tool.blankj.utilcode.util;

import androidx.collection.SimpleArrayMap;

import kantvai.tool.blankj.utilcode.constant.RegexConstants;
...
public final class RegexUtils {
    ...
    public static boolean isFromAnyOfEmailProviders(String email, String[] emailProviders) {
        return kantvai.tool.blankj.utilcode.util.ArrayUtils.contains(emailProviders, extractEmailProvider(email));
    }
