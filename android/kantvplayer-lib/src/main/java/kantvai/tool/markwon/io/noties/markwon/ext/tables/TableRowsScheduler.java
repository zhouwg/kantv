...
abstract class TableRowsScheduler {
    ...
    static void schedule(@NonNull final TextView view) {
        ...
        if (spans != null
            ...
            if (view.getTag(com.kantvai.kantvplayerlib.R.id.markwon_tables_scheduler) == null) {
                final View.OnAttachStateChangeListener listener = new View.OnAttachStateChangeListener() {
                    ...
                    public void onViewDetachedFromWindow(View v) {
                        ...
                        view.setTag(com.kantvai.kantvplayerlib.R.id.markwon_tables_scheduler, null);
                    }
                };
                view.addOnAttachStateChangeListener(listener);
                view.setTag(com.kantvai.kantvplayerlib.R.id.markwon_tables_scheduler, listener);
            }
