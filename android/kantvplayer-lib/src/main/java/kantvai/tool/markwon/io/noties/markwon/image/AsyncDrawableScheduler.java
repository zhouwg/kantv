...
public abstract class AsyncDrawableScheduler {
    ...
    public static void schedule(@NonNull final TextView textView) {
        ...
        final Integer lastTextHashCode =
                (Integer) textView.getTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler_last_text_hashcode);
        final int textHashCode = textView.getText().hashCode();
        if (lastTextHashCode != null
                && lastTextHashCode == textHashCode) {
            return;
        }
        textView.setTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler_last_text_hashcode, textHashCode);
        ...
        if (spans != null
            ...
            if (textView.getTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler) == null) {
                final View.OnAttachStateChangeListener listener = new View.OnAttachStateChangeListener() {
                    ...
                    public void onViewDetachedFromWindow(View v) {
                        ...
                        v.setTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler, null);
                    }
                };
                textView.addOnAttachStateChangeListener(listener);
                textView.setTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler, listener);
            }
    ...
    public static void unschedule(@NonNull TextView view) {
        ...
        // @since 4.0.0
        if (view.getTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler_last_text_hashcode) == null) {
            return;
        }
        view.setTag(com.kantvai.kantvplayerlib.R.id.markwon_drawables_scheduler_last_text_hashcode, null);
