package kantvai.tool.skinsupport;
...
import kantvai.tool.skinsupport.annotation.Nullable;
import kantvai.tool.skinsupport.app.SkinActivityLifecycle;
import kantvai.tool.skinsupport.app.SkinLayoutInflater;
import kantvai.tool.skinsupport.app.SkinWrapper;
import kantvai.tool.skinsupport.load.SkinAssetsLoader;
import kantvai.tool.skinsupport.load.SkinBuildInLoader;
import kantvai.tool.skinsupport.load.SkinNoneLoader;
import kantvai.tool.skinsupport.load.SkinPrefixBuildInLoader;
import kantvai.tool.skinsupport.observe.SkinObservable;
import kantvai.tool.skinsupport.utils.SkinPreference;
...
public class SkinCompatManager extends SkinObservable {
    ...
    /**
     * 初始化换肤框架. 通过该方法初始化，应用中Activity需继承自{@link kantvai.tool.skinsupport.app.SkinCompatActivity}.
     *
     * @param context
     * @return
     */
    ...
    /**
     * 初始化换肤框架，监听Activity生命周期. 通过该方法初始化，应用中Activity无需继承{@link kantvai.tool.skinsupport.app.SkinCompatActivity}.
     *
     ...
     *
     * @param inflater 在{@link kantvai.tool.skinsupport.app.SkinCompatViewInflater#createView(Context, String, String)}方法中调用.
     * @return
     */
     ...
     * 自定义View换肤时，可选择添加一个{@link SkinLayoutInflater}
     *
     * @param inflater 在{@link kantvai.tool.skinsupport.app.SkinCompatViewInflater#createView(Context, String, String)}方法中最先调用.
     * @return
     */
    @Deprecated
