package kantvai.tool.skinsupport.content.res;
...
import static kantvai.tool.skinsupport.content.res.SkinCompatThemeUtils.getDisabledThemeAttrColor;
import static kantvai.tool.skinsupport.content.res.SkinCompatThemeUtils.getThemeAttrColor;
import static kantvai.tool.skinsupport.content.res.SkinCompatThemeUtils.getThemeAttrColorStateList;
...
final class SkinCompatDrawableManager {
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        final Drawable d = getDrawable(context, com.kantvai.kantvplayerlib.R.drawable.abc_vector_test);
