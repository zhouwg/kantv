...
import kantvai.tool.skinsupport.widget.SkinCompatHelper;
...
public class SkinMaterialTextInputLayout extends TextInputLayout implements SkinCompatSupportable {
    ...
    public SkinMaterialTextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.kantvai.kantvplayerlib.R.styleable.TextInputLayout, defStyleAttr, R.style.Widget_Design_TextInputLayout);
    ...
    private void loadCounterTextColorResFromAttributes(@StyleRes int resId) {
        KANTVLog.g("SkinMaterialTextInputLayout", "it shouldn't happen");
        if (resId != INVALID_ID) {
            //TypedArray counterTA = getContext().obtainStyledAttributes(resId, kantvai.tool.skinsupport.R.styleable.SkinTextAppearance);
            //if (counterTA.hasValue(kantvai.tool.skinsupport.R.styleable.SkinTextAppearance_android_textColor)) {
            //    mCounterTextColorResId = counterTA.getResourceId(kantvai.tool.skinsupport.R.styleable.SkinTextAppearance_android_textColor, INVALID_ID);
            //}
            //counterTA.recycle();
        }
    ...
    private void loadErrorTextColorResFromAttributes(@StyleRes int resId) {
        KANTVLog.g("SkinMaterialTextInputLayout", "not supported");
        //if (resId != INVALID_ID) {
            //TypedArray errorTA = getContext().obtainStyledAttributes(resId, kantvai.tool.skinsupport.R.styleable.SkinTextAppearance);
            //if (errorTA.hasValue(kantvai.tool.skinsupport.R.styleable.SkinTextAppearance_android_textColor)) {
            //    mErrorTextColorResId = errorTA.getResourceId(kantvai.tool.skinsupport.R.styleable.SkinTextAppearance_android_textColor, INVALID_ID);
           // }
            //errorTA.recycle();
        //}
