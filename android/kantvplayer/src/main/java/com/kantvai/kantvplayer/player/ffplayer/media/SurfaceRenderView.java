...
import kantvai.media.player.ISurfaceTextureHolder;


public class SurfaceRenderView extends SurfaceView implements IRenderView {
    private final static String TAG = SurfaceRenderView.class.getName();
    ...
    public void setVideoRotation(int degree) {
        KANTVLog.e(TAG, "SurfaceView doesn't support rotation (" + degree + ")!\n");
    }
