...
public class TableLayoutBinder {
    ...
    public View appendCalendar() {
        ViewGroup rowView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.table_media_info_calendar, mTableLayout, false);
        CalendarView mCalendarView = (CalendarView) rowView.findViewById(R.id.video_calendar);
        boolean isYear = mCalendarView.isYearSelectLayoutVisible();
        KANTVLog.d(TAG, "isYear: " + isYear);
        //mCalendarView.showYearSelectLayout(2021);
    ...
    public void setBackgroundColor (int color) {
        mTableView.setBackgroundColor(color);
    }
