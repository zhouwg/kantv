...
import com.kantvai.kantvplayer.utils.scan.camera.CameraManager;
...
public class QRCodeReaderView extends SurfaceView
    ...
    public String getSizeInfo(){
        return  "preview size："+mPreviewWidth+"x"+mPreviewHeight+"\n"+
                "screen size："+this.getHeight()+"x"+this.getWidth();
    }
