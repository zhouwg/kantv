...
public class DefaultLoadControl implements LoadControl {
  ...
  protected int calculateTargetBufferBytes(
    ...
    CDELog.j(TAG, "DEFAULT_MIN_BUFFER_SIZE: " + DEFAULT_MIN_BUFFER_SIZE / 1024  + "kbytes," + DEFAULT_MIN_BUFFER_SIZE / 1024 / 1024 + "Mbytes"); //12mbytes
    CDELog.j(TAG, "target buffer bytes:" + (max(DEFAULT_MIN_BUFFER_SIZE, targetBufferSize)) / 1024 + "kbytes," + (max(DEFAULT_MIN_BUFFER_SIZE, targetBufferSize)) / 1024 / 1024 + "Mbytes");
