...
/* package */ class HlsChunkSource {
  ...
  public void maybeThrowError() throws IOException {
    if (fatalError != null) {
      CDELog.j(TAG, "fatal error: " + fatalError.toString());
      throw fatalError;
    }
    if (expectedPlaylistUrl != null && seenExpectedPlaylistError) {
      CDELog.j(TAG, "expectedPlaylistUrl: " + expectedPlaylistUrl + ",seenExpectedPlaylistError: " + seenExpectedPlaylistError);
  ...
  public void getNextChunk(
    ...
    if (chunkMediaSequence < playlist.mediaSequence && previous != null && switchingTrack) {
      CDELog.j(TAG, "chunkMediaSequence=" + chunkMediaSequence + "  playlist.mediaSequence=" + playlist.mediaSequence);
