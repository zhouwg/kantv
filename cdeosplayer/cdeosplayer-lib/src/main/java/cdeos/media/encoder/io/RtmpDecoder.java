...
import cdeos.media.encoder.packets.RtmpHeader;
import cdeos.media.encoder.packets.RtmpPacket;
import cdeos.media.encoder.packets.SetChunkSize;
...
import cdeos.media.encoder.packets.Acknowledgement;
    ...
    public RtmpPacket readPacket(InputStream in) throws IOException {
        ...
        switch (header.getMessageType()) {
            case SET_CHUNK_SIZE:
                ...
                CDELog.j(TAG, "readPacket(): Setting chunk size to: " + setChunkSize.getChunkSize());
