 ...
 * protected stream.
 *
 * @see cdeos.media.encoder.iso.boxes.odf.OmaDrmKeyManagenentSystemBox
 * @see cdeos.media.encoder.iso.boxes.sampleentry.AudioSampleEntry#TYPE_ENCRYPTED
 * @see cdeos.media.encoder.iso.boxes.sampleentry.VisualSampleEntry#TYPE_ENCRYPTED
 */
