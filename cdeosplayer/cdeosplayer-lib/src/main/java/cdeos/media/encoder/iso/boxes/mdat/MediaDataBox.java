...
package cdeos.media.encoder.iso.boxes.mdat;

import cdeos.media.encoder.iso.BoxParser;
import cdeos.media.encoder.iso.ChannelHelper;
 ...
 * by the metadata (see {@link cdeos.media.encoder.iso.boxes.SampleTableBox}).<br>
 ...
 * metadata refers to media data by its absolute offset within the file (see {@link cdeos.media.encoder.iso.boxes.StaticChunkOffsetBox});
