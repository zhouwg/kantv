...
import cdeos.media.encoder.mp4parser.util.ByteBufferByteChannel;
 ...
 *
 * @see cdeos.media.encoder.iso.boxes.sampleentry.AudioSampleEntry
 * @see cdeos.media.encoder.iso.boxes.sampleentry.VisualSampleEntry
 * @see cdeos.media.encoder.iso.boxes.sampleentry.TextSampleEntry
 */
