...
import cdeos.media.encoder.iso.boxes.*;
import cdeos.media.encoder.iso.boxes.fragment.*;
...
public class FragmentedMp4Builder implements Mp4Builder {
     ...
     * <ul>
     * <li>{@link #createMvhd(cdeos.media.encoder.mp4parser.authoring.Movie) mvhd}</li>
     * <li>{@link #createMvex(cdeos.media.encoder.mp4parser.authoring.Movie)  mvex}</li>
     * <li>a {@link #createTrak(cdeos.media.encoder.mp4parser.authoring.Track, cdeos.media.encoder.mp4parser.authoring.Movie)  trak} for every track</li>
     * </ul>
     *
     * @param movie the concerned movie
     ...
     * isofile. Uses {@link #createTfra(cdeos.media.encoder.mp4parser.authoring.Track, cdeos.media.encoder.iso.IsoFile)}
     ...
     * by calling {@link #createTrex(cdeos.media.encoder.mp4parser.authoring.Movie, cdeos.media.encoder.mp4parser.authoring.Track)}
