 ...
 */
package cdeos.media.encoder.mp4parser.authoring.tracks;

import cdeos.media.encoder.iso.boxes.*;
import cdeos.media.encoder.iso.boxes.sampleentry.TextSampleEntry;
import cdeos.media.encoder.mp4parser.authoring.AbstractTrack;
import cdeos.media.encoder.mp4parser.authoring.TrackMetaData;
import cdeos.media.encoder.mp4parser.boxes.apple.BaseMediaInfoAtom;
import cdeos.media.encoder.mp4parser.boxes.apple.GenericMediaHeaderAtom;
import cdeos.media.encoder.mp4parser.boxes.apple.GenericMediaHeaderTextAtom;
import cdeos.media.encoder.mp4parser.boxes.apple.QuicktimeTextSampleEntry;
import cdeos.media.encoder.mp4parser.boxes.threegpp26245.FontTableBox;
