...
import cdeos.media.player.annotations.AccessedByNative;
import cdeos.media.player.annotations.CalledByNative;
import cdeos.media.player.bean.TrackInfoBean;
import cdeos.media.player.misc.IAndroidIO;
...
public final class FFmpegMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setSurface(Surface surface) {
        if (mScreenOnWhilePlaying && surface != null) {
            CDELog.w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
        mSurfaceHolder = null;
        _setVideoSurface(surface);
        updateSurfaceScreenOn();
    ...
    public void start() throws IllegalStateException {
        ...
        _setEnableDumpES(CDEUtils.VIDEO_TRACK, mEnableDumpVideoES ? 1 : 0);
        _setEnableDumpES(CDEUtils.AUDIO_TRACK, mEnableDumpAudioES ? 1 : 0);
    ...
    public void setScreenOnWhilePlaying(boolean screenOn) {
        if (mScreenOnWhilePlaying != screenOn) {
            if (screenOn && mSurfaceHolder == null) {
                CDELog.w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public void setEnableDumpVideoES(boolean bEnableDumpVideoES) {
        ...
        CDELog.d(TAG, "enable dump video es: " + mEnableDumpVideoES);
        _setEnableDumpES(CDEUtils.VIDEO_TRACK, mEnableDumpVideoES ? 1 : 0);
    }
    ...
    public void setEnableDumpAudioES(boolean bEnableDumpAudioES) {
        ...
        CDELog.d(TAG, "enable dump audio es: " + bEnableDumpAudioES);
        _setEnableDumpES(CDEUtils.AUDIO_TRACK, mEnableDumpAudioES ? 1 : 0);
    }
    ...
    public void setEnableRecord(boolean bEnableRecord) {
        ...
        CDELog.d(TAG, "enable record: " + mEnableRecord);
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (player == null || player.mNativeMediaPlayer == 0) {
                CDELog.w(TAG, "it shouldn't happen, pl check");
                return;
            }
            ...
            switch (msg.what) {
                ...
                case MEDIA_BUFFERING_UPDATE:
                    ...
                    CDELog.d(TAG, "Buffer: percent:" + percent + ", bufferPostion: " + bufferPosition + ", duration : " + duration);
    ...
    private static void postEventFromNative(Object weakThiz, int what,
        ...
        if (weakThiz == null) {
            CDELog.g(TAG, "why weakThiz is null");
            return;
        }
        ...
        if (mp.mEventHandler != null) {
            ...
            CDELog.g(TAG, "mp.mEventHandler is null");
        }
    }
    ...
    private static boolean onNativeInvoke(Object weakThiz, int what, Bundle args) {
        CDELog.d(TAG, "onNativeInvoke: " + what );
