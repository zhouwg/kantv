...
public class RecentMediaStorage {
    ...
    public void saveUrlAsync(String url) {
        new AsyncTask<String, Void, Void>() {
            ...
            protected Void doInBackground(String... params) {
                //CDELog.d(TAG, "params[0] : " + params[0]);
                saveUrl(params[0]);
                return null;
            }
        }.execute(url);
    ...
    public void saveUrl(String syncUrl) {
        ...
        try {
            ...
            if (4 != strArr.length) {
                CDELog.w(TAG, "it shouldn't happen here, pls check");
                return;
            }
            url = strArr[0];
            mediaType = strArr[1];
            ...
            //CDELog.d(TAG,"url: " + url + " mediatype:" + mediaType + " mediaTitle:" + title + " playPos: " + Long.valueOf(playPos));
            ...
            CDELog.w(TAG, "can't get url and mediatype" + ex.getMessage());
            return;
        } finally {
           return;
        }
