 ...
 public class AIAgentFragment_bk extends BaseMvpFragment<AIAgentPresenter> implements AIAgentView, RtmpHandler.RtmpListener,
     ...
     private AIAgentFragment_bk.MyEventListener mEventListener = new AIAgentFragment_bk.MyEventListener();
     ...
     protected int initPageLayoutId() {
         return R.layout.fragment_agent_bk;
     }
