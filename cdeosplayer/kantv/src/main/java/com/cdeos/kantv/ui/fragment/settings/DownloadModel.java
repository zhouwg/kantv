 ...
 public class DownloadModel {
     ...
     private void showDownloadDialog() {
         ...
         builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
             ...
             public void onClick(DialogInterface dialog, int which) {
                 ...
                 if (apkFile.exists()) {
                     CDELog.j(TAG, "file: " + localModleFileA + "exist, remove it");
     ...
     private Runnable modelDownloadRunnable = new Runnable() {
         ...
         public void run() {
             ...
             if (0 == result) {
                 CDELog.j(TAG, "download  file succeed:" + remoteModleFileA);
                 mHandler.sendEmptyMessage(DOWN_OVER_FILE);
             } else {
                 CDELog.j(TAG, "download file failed:" + remoteModleFileA);
         ...
         public void handleMessage(android.os.Message msg) {
             switch (msg.what) {
                 ...
                 case DOWN_FILE_FAILED:
                     ...
                     CDEUtils.showMsgBox(mContext, errorString);
                     break;
