package com.cdeos.kantv.utils.net.okhttp;

import androidx.annotation.NonNull;

import com.blankj.utilcode.util.LogUtils;
import com.cdeos.kantv.app.IApplication;
import com.cdeos.kantv.utils.interf.Engine;
...
public final class OkHttpEngine implements Engine {
    ...
    public void arrayParams(@NonNull FormBody.Builder body, @NonNull List<String> value, @NonNull String key) {
        ...
        LogUtils.i("key-value", "key--value===>" + String.format("%s[]", key) + "--" + strVal);
    ...
    public String cookieHeader(List<Cookie> cookies) {
        ...
        LogUtils.i("cookies", cookieHeader.toString());
