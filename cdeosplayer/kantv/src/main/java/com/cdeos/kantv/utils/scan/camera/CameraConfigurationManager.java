...
package com.cdeos.kantv.utils.scan.camera;
...
import com.cdeos.kantv.utils.scan.camera.open.CameraFacing;
import com.cdeos.kantv.utils.scan.camera.open.OpenCamera;
import com.cdeos.kantv.utils.scan.view.SimpleLog;
...
final class CameraConfigurationManager {
  ...
  private static final int MAX_PREVIEW_PIXELS = ScreenUtils.getScreenHeight() * ScreenUtils.getScreenWidth();
  ...
  void initFromCameraParameters(OpenCamera camera, int width, int height) {
    ...
    Point previewSizeResolution = new Point();
    display.getSize(previewSizeResolution);
    previewSizeOnScreen = previewSizeResolution;
  }
  ...
  void setTorchEnabled(Camera camera, boolean enabled) {
    Camera.Parameters parameters = camera.getParameters();
    setTorchEnabled(parameters, enabled, true);
