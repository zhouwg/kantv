...
public:
    ...
    bool load_from_file(const std::string& model_path,
        ...
        if (version == VERSION_COUNT) {
            ...
            GGML_JNI_NOTIFY("get sd version from file failed: '%s'", model_path.c_str());
            return false;
        }
...
sd_ctx_t* new_sd_ctx(const char* model_path_c_str,
    ...
    LOG_DEBUG("load model from file %s", model_path.c_str());
    GGML_JNI_NOTIFY("load model from file %s", model_path.c_str());
