...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(ggml_dsp_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(ggml_dsp_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(ggml_dsp_setclocks)(remote_handle64 _h, int32 diag_info, int32 requested_thread_counts, int32* actual_thread_counts) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(ggml_dsp_register_rpcmem)(remote_handle64 _h, uint32 ion_fd, uint32 size_lo, uint32 size_hi) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(ggml_dsp_execute_batch)(remote_handle64 _h, uint32 batch_offset, uint32 batch_size) __QAIC_HEADER_ATTRIBUTE;
#ifndef ggml_dsp_URI
#define ggml_dsp_URI "file:///libggml_dsp_skel.so?ggml_dsp_skel_handle_invoke&_modver=1.0&_idlver=0.0.2"
#endif /*ggml_dsp_URI*/
#ifdef __cplusplus
}
#endif
