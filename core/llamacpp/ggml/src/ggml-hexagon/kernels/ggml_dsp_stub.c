#ifndef _GGML_DSP_STUB_H
#define _GGML_DSP_STUB_H
#include "ggml_dsp.h"
#include <string.h>
#ifndef _WIN32
#include "HAP_farf.h"
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(ggml_dsp_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(ggml_dsp_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_close)(h);
}
static __inline int _stub_method(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1], uint32_t _rout2[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[2] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(ggml_dsp_setclocks)(remote_handle64 _handle, int32 diag_info, int32 requested_thread_counts, int32* actual_thread_counts) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method(_handle, _mid, (uint32_t*)&diag_info, (uint32_t*)&requested_thread_counts, (uint32_t*)actual_thread_counts);
}
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1], uint32_t _in2[1]) {
   remote_arg _pra[1] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(ggml_dsp_register_rpcmem)(remote_handle64 _handle, uint32 ion_fd, uint32 size_lo, uint32 size_hi) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_1(_handle, _mid, (uint32_t*)&ion_fd, (uint32_t*)&size_lo, (uint32_t*)&size_hi);
}
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(ggml_dsp_execute_batch)(remote_handle64 _handle, uint32 batch_offset, uint32 batch_size) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   return _stub_method_2(_handle, _mid, (uint32_t*)&batch_offset, (uint32_t*)&batch_size);
}
#ifdef __cplusplus
}
#endif
#endif //_GGML_DSP_STUB_H
