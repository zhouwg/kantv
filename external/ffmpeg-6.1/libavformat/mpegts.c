...
static const StreamType ISO_types[] = {
    ...
    { 0x5a, AVMEDIA_TYPE_VIDEO, AV_CODEC_ID_AV1        }, /* weiguo,added */
    { 0x57, AVMEDIA_TYPE_VIDEO, AV_CODEC_ID_WEBP       }, /* weiguo,added */
    { 0 },
};
...
static const StreamType REGD_types[] = {
    ...
    { MKTAG('A', 'V', '-', '1'), AVMEDIA_TYPE_VIDEO, AV_CODEC_ID_AV1   },
    { MKTAG('W', 'E', 'B', 'P'), AVMEDIA_TYPE_VIDEO, AV_CODEC_ID_WEBP  },
