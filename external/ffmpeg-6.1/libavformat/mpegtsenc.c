...
static int get_dvb_stream_type(AVFormatContext *s, AVStream *st)
{
    ...
    switch (st->codecpar->codec_id) {
        //2023-12-18,weiguo added
    case AV_CODEC_ID_WEBP:
        stream_type = STREAM_TYPE_VIDEO_WEBP;
        break;
    case AV_CODEC_ID_AV1:
        stream_type = STREAM_TYPE_VIDEO_AV1;
        break;
        //weiguo, end added
    ...
    for (i = 0; i < s->nb_streams; i++) {
        ...
        *q++ = stream_type;
        ...
        case AVMEDIA_TYPE_VIDEO:
            ...
            } else if (stream_type == STREAM_TYPE_VIDEO_AV1) {
                put_registration_descriptor(&q, MKTAG('A', 'V', '-', '1'));
            } else if (stream_type == STREAM_TYPE_VIDEO_WEBP) {
                put_registration_descriptor(&q, MKTAG('W', 'E', 'B', 'P'));
