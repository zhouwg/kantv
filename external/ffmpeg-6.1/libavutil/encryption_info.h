...
//weigo begin added 
//weiguo,TODO: unify HLS SampleAES/SampleSM4 decrypt
...
//ChinaDRM
//Huawei    WisePlay
#define MAX_CENC_DRM_COUNTS ( (5 + 1) * 2)
#define MAX_CENC_PSSH_SIZE  1024
typedef struct DASHEncryptInfo {
    char content_type[MAX_CENC_INFO_SIZE];
    ...
    char cenc_pssh[MAX_CENC_PSSH_SIZE];
} DASHEncryptInfo;

//weiguo 与KanTV中保持一致
typedef enum AVDrmID {
   DRM_SCHEME_CHINADRM,
   DRM_SCHEME_WISEPLAY,
   DRM_SCHEME_FAIRPLAY,
...
//weiguo 与KanTV中保持一致
typedef enum AVEncryptMethodID {
    ENCRYPT_NONE           = 0,
    ENCRYPT_SAMPLE_SM4     = 0x1,        //SM4 ES 10%
    ENCRYPT_SM4_CBC        = 0x3,        //SM4 ES 100%
    ENCRYPT_SAMPLE_AES     = 0x4,        //AES 10%
    ENCRYPT_AES_CBC        = 0x5,        //AES 100%
    ENCRYPT_SAMPLE_SM4_0   = 0x6,        //SM4 ES 0%
    ENCRYPT_SAMPLE_SM4_1   = 0x7,        //SM4 ES 1%
} AVEncodeMethodID;
//weigo end added
