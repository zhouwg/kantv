...
const char *av_version_info(void)
{
    ...
    static char av_version_info[128] = { 0 };
    if (av_version_info[0] == 0) {
        memset(av_version_info, 0, 128);
        snprintf(av_version_info, 128, "%s, build time:%s,%s", FFMPEG_VERSION, __DATE__, __TIME__);
    }
