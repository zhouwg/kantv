...
- Hexagon_SDK: a customized/tailored Qualcomm's Hexagon SDK for build project KanTV conveniently. the fully Hexagon SDK must be obtained with a Qualcomm Developer Account.
